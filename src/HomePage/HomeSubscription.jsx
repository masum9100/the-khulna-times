...
const HomeSubscription = () => {
    return (
        <div>
            ...
            {/* plan 2 */}
            <div className='flex justify-center'>
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 hover:bg-gradient-to-b from-[#F9F4FC] to-[#EEE8FB] my-2">
