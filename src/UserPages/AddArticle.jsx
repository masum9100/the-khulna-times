...
const AddArticle = () => {
    ...
    const handleAddArticle = event => {
        ...
        const newArticle = { newsTitle, short_description, long_description, user_email, photo_url1, photo_url2, tag: selectedTag }
            ...
            <form onSubmit={handleAddArticle}>
                <div className='grid gap-7'>
                    ...
                    <div className='mx-auto '>
                        <p className='text-left font-semibold  text-xl mb-2'>Select Tag</p>
